...
# 15-6. Two D8s: Create a simulation showing what happens when you roll two eight-sided dice
...
# 15-7. Three Dice: When you roll three D6 dice, the smallest number you can roll is 3 and the
# largest number is 18. Create a visualization that shows what happens when you roll three D6
# dice.

# 15-8. Multiplication: When you roll two dice, you usually add the two numbers together to
# get the result. Create a visualization that shows what happens if you multiply these numbers
# instead.

# 15-9. Die Comprehensions: For clarity, the listings in this section use the long form of for
